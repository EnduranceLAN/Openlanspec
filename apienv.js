...
$(document).ready(function () {
    ...
    var specs1 = {
 "description":"LANAPI 0.1",
  "type":"object",
  "properties":{
    "api":{
      "description":"The version of LANAPI your endpoint uses",
      "type":"string",
      "required":true,
      "enum":[
        "0.1"
    ...
    "LAN":{
      "description":"The name of your LANParty",
      "type":"string",
      "required":true
    },
    "logo":{
      "description":"URL to your LAN's Logo",
      "type":"string",
      "required":true
    },
    "url":{
      "description":"URL to your LAN's website",
      "required":true,
      "type":"string"
    },
    "location":{
      ...
      "properties":{
        "address":{
          "description":"The postal address of your LAN (street, block, housenumber, zip code, city, whatever you usually need in your country, and the country itself).<br>Examples: <ul><li>Netzladen e.V., Breite Stra\u00dfe 74, 53111 Bonn, Germany<\/li><\/ul>",
          "required":false,
          "type":"string"
        },
        "lat":{
          "description":"Latitude of your LAN location, in degree with decimal places. Use positive values for locations north of the equator, negative values for locations south of equator.",
          "required":true,
          "type":"number"
        },
        "lon":{
          "description":"Longitude of your LAN location, in degree with decimal places. Use positive values for locations west of Greenwich, and negative values for locations east of Greenwich.",
          "required":true,
          "type":"number"
        }
      }
    ...
    "LANfed":{
      ...
      "properties":{
        "LANnet":{
          "description":"See the <a target=\"_blank\" href=\"https:\/\/LANfed.net\/wiki\/index.php\/Category:Howto\/LANnet\">wiki<\/a>.",
          "required":true,
          "type":"boolean"
        },
        "LANsaml":{
          "description":"See the <a target=\"_blank\" href=\"https:\/\/LANfed.net\/wiki\/index.php\/Category:Howto\/LANsaml\">wiki<\/a>.",
          "required":true,
          "type":"boolean"
        },
        "LANphone":{
          "description":"See the <a target=\"_blank\" href=\"https:\/\/LANfed.net\/wiki\/index.php\/Category:Howto\/LANphone\">wiki<\/a>.",
          "required":true,
          "type":"boolean"
        }
      }
    ...
    "cam":{
      "description":"URL(s) of webcams in your LAN",
      "required":false,
      "type":"array",
      "items":{
        "type":"string"
    ...
    "stream":{
      "description":"A mapping of stream types to stream URLs.If you use other stream types make a <a href=\"add-your-LAN\" target=\"_blank\">change request<\/a> or prefix yours with <samp>ext_<\/samp> .",
      "required":false,
      "type":"object",
      "properties":{
        "m4":{
    ...
    "state":{
      ...
      "properties":{
        "open":{
          "description":"A flag which indicates if the LAN is currently open or closed. The state 'undefined' can be achieved by assigning this field the value 'null' (without the quotes). In most (all?) programming languages this is evaluated to false so that no app should break",
          "required":true,
          "type":[
            "boolean",
            "null"
        ...
        "lastchange":{
          "description":"The Unix timestamp when the LAN status changed most recently",
          "required":false,
          "type":"number"
        },
        "trigger_person":{
          "description":"The person who lastly changed the state e.g. opened or closed the LAN.",
          "required":false,
          "type":"string"
        },
        "message":{
          "description":"An additional free-form string, could be something like <samp>'open for public'<\/samp>, <samp>'admins only'<\/samp> or whatever you want it to be",
          "required":false,
          "type":"string"
        },
        "icon":{
          ...
          "properties":{
            "open":{
              "description":"The URL to your customized LAN logo showing an open LAN",
              "type":"string",
              "required":true
            },
            "closed":{
              "description":"The URL to your customized LAN logo showing a closed LAN",
              "type":"string",
              "required":true
            }
          }
    ...
    "events":{
      "description":"Events which happened recently in your LAN and which could be interesting to the public, like 'User X has entered\/triggered\/did something at timestamp Z'",
      "required":false,
      "type":"array",
      "items":{
        "required":false,
    ...
    "contact":{
      "description":"Contact information about your LAN. You must define at least one which is in the list of allowed values of the issue_report_channels field.",
      "required":true,
      "type":"object",
      "properties":{
        "phone":{
        ...
        "sip":{
          "description":"URI for Voice-over-IP via SIP. Example: <samp>sip:yourLAN@sip.example.org<\/samp>",
          "required":false,
          "type":"string"
        },
        "lanadmins":{
          "description":"Persons who carry a key and are able to open the LAN upon request. One of the fields irc_nick, phone, email or twitter must be specified.",
          "required":false,
          "type":"array",
          "minItems":1,
          "items":{
            ...
            "properties":{
              ...
              "twitter":{
                "description":"Facebook address eg facebook.com/name",
                "required":false,
                "type":"string"
              }
            }
        ...
        "identica":{
          "description":"Identi.ca or StatusNet account, in the form <samp>yourLAN@example.org<\/samp>",
          "required":false,
          "type":"string"
        },
        "foursquare":{
        ...
        "email":{
          "description":"E-mail address for contacting your LAN. If this is a mailing list consider to use the contact\/ml field.",
          "required":false,
          "type":"string"
        },
        "ml":{
    ...
    "sensors":{
      "description":"Data of various sensors in your LAN (e.g. temperature, humidity, amount of Club-Mate left, \u2026). The only canonical property is the <em>temp<\/em> property, additional sensor types may be defined by you. In this case, you are requested to share your definition for inclusion in this specification.",
      "required":false,
      "type":"object",
      "properties":{
        "temperature":{
        ...
        "beverage_supply":{
          "description":"How much softdrink and caffeine is in your fridge?",
          "required":false,
          "type":"array",
          "items":{
            "type":"object",
        ...
        "power_consumption":{
          "description":"The power consumption of a specific device or of your whole LAN.",
          "required":false,
          "type":"array",
          "items":{
            "type":"object",
            ...
            "properties":{
              "properties":{
                ...
                "properties":{
                  ...
                  "direction":{
                    "description":"The wind direction in degrees. Use this <a href=\"https:\/\/github.com\/slopjong\/OpenLANLint\/issues\/80\" target=\"_blank_\">mapping<\/a> to convert the degrees into a string.",
                    "required":true,
                    "type":"object",
                    "properties":{
                      "value":{
        ...
        "network_connections":{
          ...
          "items":{
            ...
            "properties":{
              "type":{
                "description":"This field is optional but you can use it to the network type such as <samp>wifi<\/samp> or <samp>cable<\/samp>. You can even expose the number of <a href=\"https:\/\/LANfed.net\/wiki\/index.php\/LANnet\" target=\"_blank\">LANnet<\/a>-authenticated connections.",
                "required":false,
                "type":"string",
                "enum":[
                  "wifi",
        ...
        "wan_link":{
          "description":"How big is your LANs internet tubes",
          "required":false,
          "type":"array",
          "items":{
            "type":"object",
            "properties":{
              ...
              "unit":{
                "description":"how big are your numbers?",
                "required":true,
                "type":"string",
                "enum":[
                  "MBITS",
              ...
              "location":{
                "description":"If you have more than one wan link, you can specifity where this one is.",
                "required":false,
                "type":"string"
              },
              "name":{
        ...
        "total_attendee_count":{
          "description":"Specify the number of LAN attendees.",
          "required":false,
          "type":"array",
          "items":{
            "type":"object",
            "properties":{
              "value":{
                "description":"The amount of your LAN attendees.",
                "required":true,
                "type":"number"
              },
              "location":{
                "description":"Specify the location if your LAN has different locations (for whatever reason). This field is for one location. Every location should have its own sensor instance.",
                "required":false,
                "type":"string"
              },
              "name":{
        ...
        "people_now_present":{
          "description":"Specify the number of people that are currently in your LAN. Optionally you can define a list of names.",
          "required":false,
          "type":"array",
          "items":{
            "type":"object",
    ...
    "feeds":{
      "description":"Feeds where users can get updates of your LAN",
      "required":false,
      "type":"object",
      "properties":{
        "blog":{
    ...
    "cache":{
      "description":"Specifies options about caching of your LANAPI endpoint. Use this if you want to avoid hundreds\/thousands of application instances crawling your status.",
      "required":false,
      "type":"object",
      "properties":{
        "schedule":{
    ...
    "radio_show":{
      "description":"A list of radio shows that your LAN might broadcast.",
      "required":false,
      "type":"array",
      "items":{
        "type":"object",
	...
	"twitch_stream":{
      "description":"A list of twitch.tv streams that your LAN might broadcast.",
      "required":false,
      "type":"array",
      "items":{
        "type":"object",
        "properties":{
          ...
          "url":{
            "description":"The stream URL which must end in a username or a filename",
            "required":true,
            "type":"string"
          },
          "type":{
    ...
    apienv = JSV.createEnvironment("json-schema-draft-01");
    apienv.createSchema(specs8, undefined, "http://lanapi.net/specs1");
});